    ...
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="bg-white border border-slate-200 rounded-xl shadow-lg p-8">
          <form action="space-y-6" onSubmit={handleSubmit}>
            <InputField
              label="Email"
              name="email"
              type="email"
            ...
            <InputField
              ...
              required
            />
            <Button type="submit" isLoading={isLoading} className="w-full my-5">
              Sign In
            </Button>
          </form>

          <p className="text-center text-sm text-slate-600 at-8">
