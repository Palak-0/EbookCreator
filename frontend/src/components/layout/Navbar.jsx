          ...
          <nav className="px-4 py-2 space-y-1">
            {navLinks.map((link) => (
              <a
                key={link.name}
                href={link.href}
                className="block px-4 py-2 text-sm font-medium text-gray-700 hover:text-violet-600 hover:bg-violet-50 transition-all duration-200"
              >
                {link.name}
              </a>
            ))}
            ...
            {isAuthenticated ? (
              <div className="space-y-3">
                <div className="flex items-center space-x-3 px-2">
                  <div className="w-8 h-8 bg-linear-to-br from-violet-400 to-purple-500 rounded-xl flex items-center justify-center">
              ...
              <div className="space-y-2">
                <Link
                  to="/login"
                  className="block text-center px-4 py-2.5 text-sm text-gray-600 hover:text-gray-900 hover:bg-gray-50 rounded-lg transition-all duration-200"
                >
                  Login
                </Link>
                <Link
                  to="/signup"
                  className="block text-center px-4 py-2.5 text-sm font-medium text-white bg-linear-to-br from-violet-600 to-purple-600 rounded-lg shadow-violet-500/30 transition-all duration-200"
                >
                  Get Started
                </Link>
              </div>
