      ...
      {isOpen && (
        <div className="absolute right-0 mt-2 w-56 bg-white rounded-lg shadow-lg border border-gray-200 z-50">
          ...
          <a
            ...
            className=" px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 flex items-center space-x-2 transition-colors cursor-pointer"
          >
            View Profile
          </a>
          {/* Logout */}
          <div className="border-t border-gray-100 mt-2 py-2">
            <a
              href="#"
              onClick={onLogout}
              className=" px-4 py-2 text-sm text-red-600 hover:bg-gray-100 flex items-center space-x-2 transition-colors cursor-pointer"
            >
              Sign Out
            </a>
          </div>
