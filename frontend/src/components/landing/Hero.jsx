...
const Hero = () => {
  ...
  return (
    <div className="relative bg-linear-to-br from-violet-50 via-white to-purple-50 overflow-hidden">
      ...
      <div className="absolute bottom-20 right-10 w-96 bg-purple-200/50 rounded-full blur-3xl animate-pulse delay-700"></div>
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 py-24 lg:py-32 relative">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="max-w-xl space-y-8">
            ...
            <h1
              className="text-5xl sm:text-6xl lg:text-6xl font-bold text-gray-900 leading-tight tracking-tight"
              style={{
                fontFamily:
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
              <Link
                ...
                className="group inline-flex items-center space-x-2 bg-linear-to-r from-violet-600 to-purple-600 text-white px-8 py-4 rounded-xl font-semibold shadow-violet-500/30 hover:shadow-violet-500/50 hover:scale-105 transition-all duration-200"
              >
          ...
          <div className="relative lg:pl-8">
            <div className="relative">
              <div className="absolute inset-4 bg-linear-to-r from-violet-600 to-purple-600 rounded-3xl opacity-30 blur-2xl"></div>
              <div className="relative bg-white rounded-xl shadow-xl overflow-hidden border border-gray-100">
                <img
                  src={HERO_IMG}
                  alt="AI eBook Creator"
                  className="w-full h-[320px] lg:h-[520px] object-contain bg-white"
                />
